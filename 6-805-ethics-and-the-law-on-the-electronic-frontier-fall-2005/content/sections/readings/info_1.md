...
type: course
uid: 963f6cb712edd701648b00b2adeb8762
...
*   [Back to readings on information and intellectual property]({{< baseurl >}}/sections/readings/read_tlp3)
...
*   Appeals court decision ([PDF]({{< baseurl >}}/sections/readings/lotsbrldappmar95)) of March 9, 1995, reversing the District Court's 1992 ruling.

Lotus appealed the decision to the Supreme Court:

*   Lotus's petition to the Supreme Court for a writ of certiorari ([PDF]({{< baseurl >}}/sections/readings/lotuscertpet)), June 7, 1995.
*   Borland's brief in opposition ([PDF]({{< baseurl >}}/sections/readings/borlandcertoppo)) to petition for certiorari, July, 1995.
*   Lotus's reply ([PDF]({{< baseurl >}}/sections/readings/lotuscertreply)) in support of the petition.
...
*   Amicus brief ([PDF]({{< baseurl >}}/sections/readings/lpfamicus)) filed in the Supreme Court against the Lotus position, on behalf of a group of computer science professors.
*   Amicus brief ([PDF]({{< baseurl >}}/sections/readings/lpfamicus2)) filed in the Supreme Court against the Lotus position, on behalf of the League for Programming Freedom.
*   Amicus brief ([PDF]({{< baseurl >}}/sections/readings/lawprofamicus)) filed in the Supreme Court against the Lotus position, on behalf of a group of copyright law professors.
